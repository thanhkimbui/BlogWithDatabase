...
app.get("/posts/:postId", (postsGetReq, postsGetRes) => {
  const requestedPostId = postsGetReq.params.postId;

  Post.findOne({ _id: requestedPostId }, function (err, results) {
    if (!err) {
